...
$fines = @(
    ...
    '301,F000000301,123ABC,20240115,"CENTRAL EXPRESSWAY, KM 12",25.00,P,50005000'
    '302,F000000302,456DEF,20240220,HARBOUR ROUNDABOUT,40.00,I,50005200'
    '303,F000000303,789GHI,20240305,RIVERSIDE HIGHWAY,55.00,P,50005300'
    '304,F000000304,321XYZ,20240410,DOCKLANDS PORT RD,70.00,C,99999999'
    '305,F000000305,90000202,20240512,OLD TOWN PROMENADE,85.00,A,50005000'
    '306,F000000306,90000205,20240618,NORTH RING ROAD,100.00,I,50005300'
    '307,F000000307,FGN00001,20240722,NORTH RING ROAD,115.00,P,99999999'
)
$offences = @(
